...
public extension JSONParser {
    ...
    init(string: String) {
        // FIXME: While this may work now, I don't think that it is proper. The
        //        buffer is only valid within the closure as the underlying
        //        array-imp doesn't have to store it as a buffer? TBD
