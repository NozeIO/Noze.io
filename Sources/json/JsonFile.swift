...
public class JsonFileModule : NozeModule {
  ...
  public func readFile(path: String, cb: ( ErrorType?, JSON? ) -> Void) {
  ...
  public func writeFile(path: String, _ oo: Any?, cb : ( ErrorType? ) -> Void) {
...
public extension JsonFileModule {
  ...
  public func readFile(_ path: String, cb: ( ErrorType?, JSON? ) -> Void) {
  ...
  public func writeFile(_ p: String, _ oo: Any?, cb : ( ErrorType? ) -> Void) {
